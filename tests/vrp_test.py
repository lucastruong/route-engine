...
class VrpTest(unittest.TestCase):
    ...
    def testPolyline(self):
        ...
        expected_polyline = ['q`baA_mujSnA`AgDnDnL`O`@nL~OwAaGfRuDz_@rZtLnJnA~~@lKhQ|GhRlTfF~RhRpcBnJjaAoCMw@}KKy'
                             '@rEqBnOdKgBnDrB|Cd@m@e@l@tAzBiFbFmGuHKqBg@yPcFq@y@zEXlGnA`EwKr]}CzNz@~YfJpRth@pg@`EdEsD'
                             '`EW`IvG~r@}Yha@yHjE}Bjo@']
    ...
    def testRoutificFormat(self):
        ...
        expected_out = {
            ...
            'polylines': {'vehicle_1': ['q`baA_mujSnA`AgDnDnL`O`@nL~OwAaGfRuDz_@rZtLnJnA~~@lKhQ|GhRlTfF'
                                        '~RhRpcBnJjaAoCMw@}KKy@rEqBnOdKgBnDrB|Cd@m@e@l@tAzBiFbFmGuHKqBg@yPcFq@y'
                                        '@zEXlGnA`EwKr]}CzNz@~YfJpRth@pg@`EdEsD`EW`IvG~r@}Yha@yHjE}Bjo@']},
        }
